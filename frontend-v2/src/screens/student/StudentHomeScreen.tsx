...
const VOICE_SEARCH_SPEECH_THRESHOLD_DB = -50;
const VOICE_SEARCH_SILENCE_MS = 1700;
const VOICE_SEARCH_MIN_DURATION_MS = 1200;
const VOICE_SEARCH_MAX_DURATION_MS = 18000;
const VOICE_SEARCH_NO_SPEECH_TIMEOUT_MS = 7000;
const VOICE_SEARCH_NO_METERING_FALLBACK_MS = 7000;
